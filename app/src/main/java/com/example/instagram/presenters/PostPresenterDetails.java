...
public class PostPresenterDetails {
    ...
    public PostPresenterDetails(connectionError connection) {
    ...
    public void uploadPost(Uri image, final String description, final onPostUploaded callback) {
